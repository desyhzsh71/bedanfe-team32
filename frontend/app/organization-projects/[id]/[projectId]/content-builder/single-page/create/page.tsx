...
import {
    Sun, Moon, ChevronDown, LogOut, CreditCard, Settings, ArrowLeft, FileText,
} from 'lucide-react';
...
export default function CreateSinglePage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const token = getToken()!;
            const res = await api.createSinglePage(projectId, {
                name,
                apiId,
                multiLanguage,
                seoEnabled: seo,
            ...
            if (res.data?.id) {
                router.push(`/organization-projects/${orgId}/${projectId}/content-builder/single-page/${res.data.id}`);
            } else {
                goBack();
            }
        } catch (e: any) {
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-xs mb-1" style={{ color: darkMode ? '#64748B' : '#94A3B8' }}>
                                    Project / Content Builder / Create Single Page
                                </p>
                                <h2 className="text-2xl font-bold" style={{ color: darkMode ? '#E0E0E0' : '#1E293B' }}>Create Single Page</h2>
                            </div>
                        </div>
                    ...
                    <div className="w-full max-w-lg">
                        <div className="rounded-2xl shadow-sm border"
                            ...
                            <div className="flex items-center gap-3 px-7 pt-7 pb-5">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold" style={{ color: darkMode ? '#E0E0E0' : '#1E293B' }}>New Single Page</h3>
                                ...
                                {tab === 'basic' ? (
                                    <div className="space-y-5">
                                        <div>
                                            ...
                                            <input type="text" value={name} onChange={e => handleNameChange(e.target.value)} placeholder="e.g. Home"
